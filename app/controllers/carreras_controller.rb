class CarrerasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @carrera.save
        format.html { redirect_to @carrera, notice: 'Carrera creada.' }
  ...
  def update
    respond_to do |format|
      if @carrera.update(carrera_params)
        format.html { redirect_to @carrera, notice: 'Carrera actualizada.' }
  ...
  def destroy
    @carrera.destroy
    respond_to do |format|
      format.html { redirect_to carreras_url, notice: 'Carrera borrada. :(' }
